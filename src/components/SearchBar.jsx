...
export default function SearchBar() {
  ...
  return (
    <SlideUp delay={0}>
      <div className="relative z-10 flex flex-col items-center justify-center text-center text-white py-10 h-full gap-12 lg:gap-24 px-4 sm:px-6 lg:px-20">
        ...
        {/* Search Section */}
        <div className="bg-black/60 rounded-3xl lg:rounded-full py-8 xl:py-12 w-full px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-6 md:gap-8 lg:gap-10 max-w-7xl mx-auto w-full">
            ...
            <div className="flex flex-col w-full lg:hidden gap-4 sm:gap-5 md:gap-6">
              ...
              <Link 
                href="/location" 
                className="btn-wiper-bg sm:w-2/3 mx-auto h-12 rounded-full text-sm md:text-base transition-all hover:scale-105 active:scale-95"
              >
            ...
            <div className="hidden lg:flex flex-row items-center justify-between gap-4 xl:gap-6 w-full">
              ...
              <SlideUp delay={0.3}>
                <Link
                  href="/location"
                  className={`btn-wiper-bg h-12 rounded-full text-base xl:text-lg transition-all flex items-center justify-center px-6 xl:px-8 whitespace-nowrap flex-shrink-0 ${
