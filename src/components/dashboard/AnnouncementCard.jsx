...
export default function AnnouncementsCard() {
  return (
    <div className="bg-white shadow rounded-2xl p-4 py-8 w-full md:w-full xl:w-1/3 flex flex-col">
      ...
      <ul className="text-base text-[#666666] space-y-4">
        <li className="flex items-center gap-4"><BrushCleaning className="w-4 h-4 text-[#44475A]" /> Room cleaning schedule updated – 7 AM daily</li>
