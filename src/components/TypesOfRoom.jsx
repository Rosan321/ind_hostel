...
const BookingModal = ({ room, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 h-full">
      <div className="relative bg-white rounded-2xl w-full max-w-7xl max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        {/* Modal Content */}
        <div className="h-[90vh] xl:h-[80vh] overflow-y-auto">
              ...
              <div>
                ...
                <div className="mt-4 flex flex-col sm:flex-row lg:flex-col gap-3">
                  <button 
                    ...
                    className="flex-1 bg-blue-700 hover:bg-blue-600 text-white text-sm md:text-base font-semibold py-2 xl:py-3 px-2 xl:px-4 rounded-full transition-colors cursor-pointer"
                  >
                    View Details
                  </button>
                </div>
