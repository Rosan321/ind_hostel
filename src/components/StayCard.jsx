    ...
    <div className="relative bg-white shadow rounded-2xl overflow-hidden flex flex-col hover:shadow-lg transition w-full sm:max-w-md lg:max-w-lg">
      <AnimatedCard>
        ...
        <div className="absolute top-3 left-0 right-0 flex justify-between items-center z-10">
          ...
          <button className="bg-[#0D0BA8] text-[#FFFFFF] px-2 py-1 sm:px-3 sm:py-1.5 rounded-l-lg font-semibold text-xs sm:text-sm hover:bg-yellow-500 transition shadow">
            ₹ {price}/ mo
          </button>
        </div>
        ...
        <div className="p-3 sm:p-4 flex flex-col justify-between flex-1">
          <SlideUp delay={0.4}>
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#44475A] py-2">
                {location}
              </p>
